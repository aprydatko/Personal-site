  ...
  return (
    <main id="main-content" tabIndex={-1}>
      <Container className="py-8 sm:py-12">
        <Link
          href="/blog"
          className="inline-flex items-center gap-3 font-mono text-xs text-muted transition-colors hover:text-foreground"
        >
        ...
        <div className="mt-12 grid gap-14 lg:grid-cols-[minmax(0,43rem)_12rem] lg:justify-between">
          <article>
            <p className="font-mono text-xs text-muted">
              {post.date} <span className="mx-2">•</span> {post.readingTime}{' '}
              <span className="mx-2">•</span> {post.category}
            </p>
            <h1 className="mt-5 max-w-3xl font-mono text-[clamp(2.2rem,5vw,4rem)] font-medium leading-[1.13] tracking-tight">
              {post.title}
          ...
          <aside className="hidden lg:block">
            ...
            <div className="mt-10 rounded-lg border border-border-subtle p-5 font-mono text-xs text-muted">
              <p className="text-[10px]">SHARE</p>
              <div className="mt-4 space-y-4">
                <span className="flex items-center gap-3">
                  <Share2 className="size-3.5 text-foreground" /> Twitter
                </span>
                <span className="flex items-center gap-3">
                  <Link2 className="size-3.5 text-foreground" /> Copy link
                </span>
                <span className="flex items-center gap-3">
                  <Copy className="size-3.5 text-foreground" /> Share article
                </span>
              </div>
            </div>
          </aside>
