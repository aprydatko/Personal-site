      ...
      <Container className="relative">
        <div className="flex flex-col items-start gap-8 2xl:gap-16 overflow-hidden lg:flex-row border-b border-border-subtle py-10 sm:py-20">
          ...
          <div className="relative w-full min-w-0 self-stretch lg:flex-[9_1_0%]">
            ...
            />
            <div className="hidden 2xl:absolute bottom-2 right-0 flex w-20 flex-col items-end gap-3 font-mono text-base text-muted 2xl:flex">
              <span className="whitespace-nowrap">SCROLL</span>
              <span className="relative flex h-24 w-8 justify-center">
                <span className="absolute left-1/2 top-0 h-[calc(100%-12px)] w-px -translate-x-1/2 bg-muted/60" />
                <ArrowDown
                  strokeWidth={1.25}
