  ...
  return (
    <main id="main-content" className="overflow-clip" tabIndex={-1}>
      <Container>
        ...
        <div
          className="relative h-16 border-t border-border-subtle before:absolute before:-top-px before:left-0 before:w-[27%] before:border-t before:border-border-subtle before:content-[''] max-sm:before:w-[22%]"
          aria-hidden="true"
        >
