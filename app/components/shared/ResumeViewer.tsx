  ...
  return (
    <>
      <Button
        type="button"
        onClick={openResume}
        className="mt-12 w-fit gap-6 px-8 py-5 text-md tracking-wide"
      >
      ...
      >
        <div className="flex h-full flex-col">
          <header className="flex items-center justify-between border-b border-border-subtle px-5 py-4 sm:px-7">
            <div>
              <h2 id="resume-viewer-title" className="font-sans text-lg font-medium">
                Arthur Prydatko — CV
              </h2>
          ...
          <iframe
            title="Arthur Prydatko CV"
            src="/Arthur_Prydatko_CV_2026.pdf"
          ...
          <footer className="flex items-center justify-end border-t border-border-subtle px-5 py-3 sm:px-7">
            <a
              href="/Arthur_Prydatko_CV_2026.pdf"
              download
