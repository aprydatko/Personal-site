...
export const blogArticles: BlogArticle[] = [
  {
    ...
    description:
      'A practical approach to scalable fullstack applications with Next.js, Node.js and PostgreSQL.',
  ...
  },
  {
    category: 'Architecture',
    date: 'Mar 22, 2024',
    title: 'Designing scalable API architecture',
    description: 'Building API systems that scale with your product and your team.',
  ...
  },
  {
    category: 'DevOps',
    date: 'Mar 5, 2024',
    title: 'Docker setup for local development',
    description: 'A fast and reliable Docker setup for fullstack projects.',
